...
#include ":FitAllPostsGerrChkHexMv04"   //12/3/21   DHR modified to remove old Gaussian fit (GfitAllPosts)
#include  ":HelperRoutinesM3"   //9/7/21 DHR updated for Igor9  12/3/21 modified for all files in movie prompt
//#include  ":GFitForBottom"  //12/3/21 not needed anymore
#include  ":DefineArray09M"   //9/13/21, 12/3/21, 12/5/21 DHR updated
#include  ":ExamineFitGM1.12"
#include  ":PlotAlot5.5M"  
#include  ":MakeTime3"
#include ":ViewGFitErrors"
#include ":ModernClicking04"  //9/16/21 DHR updated
//#include ":FindShifts03"   //12/3/21 DHR - dropped 
#include ":MakeMaskGUI05M"  // 9/9/21 modified by YS  12/5/21  modified by DHR
#include ":Correlation"
...
// 12/10/13 -anything with "M" suffix changed for movie input data
	...
	Button PlotMSD, pos={150,160}, size={110,20},title="MSD", proc=PlotMSD

	Button MSDmap, pos={10, 190},size={130,20}, title="MSDMap",proc=calcMSDheatmap
	Button MSDstatscalc, pos={150,190}, size={110,20}, title="MSDstats", proc=calcMSDstats
...
//    endif          
   ...
   centroidgfit(f1,f2,ASTr[0],ASTr[1],ASTr[3],ASTr[4],ASTr[6],ASTr[7],$MaskString,$ShiftString) //for back compatible code
...
//    NVAR CCDflag // 6/28/06
   ...
   COUNTcentroidgfit(f1,f2,ASTr[0],ASTr[1],ASTr[3],ASTr[4],ASTr[6],ASTr[7],$MaskString,$ShiftString) 
//	Duplicate/O FitResults $FitRes_String
//	Duplicate/O FitErrors $FitErr_String
//	Save/O/P=ToPractice $FitRes_String  as FitRes_String+".ibw"	
//-	Save/O/P=ToPractice $FitErr_String as FitErr_String+".ibw"
