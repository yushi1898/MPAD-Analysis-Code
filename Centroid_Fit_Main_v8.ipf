...
#include ":FitAllPostsGerrChkHexMv06"   //12/8/21 updates DHR 12/3/21   DHR modified to remove old Gaussian fit (GfitAllPosts)
...
function COUNTGFitAll(ctrlName): ButtonControl
    ...
    variable printfrequencyflag = 0  // flag for printing frequencies to monitor progress

    variable f1=0,f2=1 // will get set inside COUNTcentroidgfit
    Prompt showimageflag, "Set = 1 to show image of each frame during fit (will be slower!)" 
    Prompt printfrequencyflag, " Set = 1 to print frequencies to monitor progress: "   
    DoPrompt "Fit frequency sweep data", showimageflag, printfrequencyflag
   ...
   COUNTcentroidgfit2(f1,f2,ASTr[0],ASTr[1],ASTr[3],ASTr[4],ASTr[6],ASTr[7],$MaskString,$ShiftString,showimageflag, printfrequencyflag) 
