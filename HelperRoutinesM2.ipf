...
// 9/8/21 DHR added for Igor9
   ...
   PlayMovieAction Stop, gotoBeginning   // reset to first frame
...
SVAR  FitBottom, FitErrBottom, FitRes_String, FitErr_String, InGuess_String, PFS_Arr
...
InGuess_String="InGuess_"+RootString
