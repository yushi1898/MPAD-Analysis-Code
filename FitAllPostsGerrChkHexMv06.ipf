...
function COUNTcentroidgfit2(f1,f2,XTop,YTop,XPosts,YPosts,zmin, zmax,maskwave,shiftwave,showimageflag, printfrequencyflag)
    variable f1,f2  	// beginning and ending file numbers
    variable XTop,YTop//   position of upper left post
    variable XPosts,YPosts  // number of posts in x,y in ROI
    variable zmin,zmax      // min and max grayscale levels for display during fitting
   ...
   variable printEveryNframes = -1  //12/8/21 flag to suppress printing Iframe counter to monitor progress
   variable i
...
//12/8/21 Several things will need to change
    print "Warning Changes Needed - find this text in FitAllPostsGerr...."
