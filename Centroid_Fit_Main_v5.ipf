...
#include  ":PlotAlot6M"    //12/5/21 YS modified
#include  ":MakeTime3"
...
#include ":Correlation"
#include ":CalcMSD3M"   // 12/6/21 DHR started fixing wave refs for Igor 9 12/5/21  YS updated.  9/7/21  DHR updated this file
#include ":Digital lock in1_12"
#include ":Histogram1_23temp"  //12/6/21  YS NEEDS TO REVIEW AND UPDATE
...
Prompt masktype_string,"Mask Type", popup "Mannual;Automatic"
...
if (stringmatch(masktype_string,"Mannual")==1)
