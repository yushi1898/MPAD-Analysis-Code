...
#include ":Correlation"
#include ":CalcMSD4M"   //12/10/21 nm/um to pixels fixed 12/6/21 DHR started fixing wave refs for Igor 9 12/5/21  YS updated.  9/7/21  DHR updated this file
#include ":Digital lock in2"  //12/10/21
...
//	Save/O/P=ToPractice $FitErrBottom as FitErrBottom+".ibw"
	Save/O/P=ToPractice $ShiftString as ShiftString+".ibw"  
       ...
       // *****Craig edit 8/16/11***********************************************************
       //12/10/21  This is obsolete.  Probably can remove.
